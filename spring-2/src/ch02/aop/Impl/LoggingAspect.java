...
public class LoggingAspect {
	// 前置通知:在目標方法開始之前執行
	// @Before("execution(public int ch02.aop.Impl.ArithmeticCalculator.*(..))")
	...
	// @After("execution(public int ch02.aop.Impl.ArithmeticCalculator.*(..))")
	...
	// ch02.aop.Impl.ArithmeticCalculator.*(..))", returning = "result")
	...
	// ch02.aop.Impl.ArithmeticCalculator.*(..))", throwing = "ex")
	...
	@Around("execution(public int ch02.aop.Impl.ArithmeticCalculator.*(..))")
